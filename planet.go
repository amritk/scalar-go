...
type Planet struct {
	...
	Satellites []PlanetSatellite `json:"satellites"`
	// A user
...
type PlanetParam struct {
	...
	Satellites param.Field[[]PlanetSatelliteParam] `json:"satellites"`
...
type PlanetSatelliteParam struct {
	Name param.Field[string] `json:"name" api:"required"`
	// Diameter in kilometers
	Diameter param.Field[float64] `json:"diameter"`
}

func (r PlanetSatelliteParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}
...
type PlanetSatellite struct {
	...
	JSON planetSatelliteJSON `json:"-"`
}

// planetSatelliteJSON contains the JSON metadata for the struct [PlanetSatellite]
type planetSatelliteJSON struct {
	Name apijson.Field
...
func (r *PlanetSatellite) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r planetSatelliteJSON) RawJSON() string {
	return r.raw
}
