...
// the [NewPlanetPizzaService] method instead.
type PlanetPizzaService struct {
	Options []option.RequestOption
}

// NewPlanetPizzaService generates a new service that applies the given options to each request.
// These options are applied after the parent client's options (if there is one), and
// before any request-specific options.
func NewPlanetPizzaService(opts ...option.RequestOption) (r *PlanetPizzaService) {
	r = &PlanetPizzaService{}
	r.Options = opts
	return
}
...
//	query: PlanetPizzaListParams request parameters.
//	opts: Options to apply to this request.
//
// Returns:
//
//	*PlanetPizzaListResponse: OK
//
// Example:
//
...
//
//	fmt.Println(pizza)
func (r *PlanetPizzaService) List(ctx context.Context, query PlanetPizzaListParams, opts ...option.RequestOption) (res *PlanetPizzaListResponse, err error) {
...
//
//	ctx: Context for the request.
//	body: PlanetPizzaNewParams request parameters.
//	opts: Options to apply to this request.
//
// Returns:
//
...
//
//	fmt.Println(pizza)
func (r *PlanetPizzaService) New(ctx context.Context, body PlanetPizzaNewParams, opts ...option.RequestOption) (res *Planet, err error) {
	opts = slices.Concat(r.Options, opts)
	path := "planets"
...
//
//	fmt.Println(pizza)
func (r *PlanetPizzaService) Get(ctx context.Context, planetID int64, opts ...option.RequestOption) (res *Planet, err error) {
	opts = slices.Concat(r.Options, opts)
...
//		panic(err)
//	}
func (r *PlanetPizzaService) Delete(ctx context.Context, planetID int64, opts ...option.RequestOption) (err error) {
	opts = slices.Concat(r.Options, opts)
...
//	ctx: Context for the request.
//	planetID: The ID of the planet to get
//	body: PlanetPizzaUploadImageParams request parameters.
//	opts: Options to apply to this request.
//
// Returns:
//
//	*PlanetPizzaUploadImageResponse: Image uploaded
//
// Example:
//
...
//
//	fmt.Println(pizza)
func (r *PlanetPizzaService) UploadImage(ctx context.Context, planetID int64, body PlanetPizzaUploadImageParams, opts ...option.RequestOption) (res *PlanetPizzaUploadImageResponse, err error) {
	opts = slices.Concat(r.Options, opts)
...
type PlanetPizzaListParams struct {
...
// URLQuery serializes [PlanetPizzaListParams]'s query parameters as `url.Values`.
func (r PlanetPizzaListParams) URLQuery() (v url.Values) {
...
type PlanetPizzaNewParams struct {
	Planet PlanetParam `json:"planet" api:"required"`
}

func (r PlanetPizzaNewParams) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r.Planet)
}

type PlanetPizzaUploadImageParams struct {
	// The image file to upload
	Image param.Field[io.Reader] `json:"image" format:"binary"`
}

func (r PlanetPizzaUploadImageParams) MarshalMultipart() (data []byte, contentType string, err error) {
...
type PlanetPizzaListResponse struct {
	Data []Planet                    `json:"data"`
	JSON planetPizzaListResponseJSON `json:"-"`
	PaginatedResource
}

// planetPizzaListResponseJSON contains the JSON metadata for the struct [PlanetPizzaListResponse]
type planetPizzaListResponseJSON struct {
	Data        apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
}

func (r *PlanetPizzaListResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r planetPizzaListResponseJSON) RawJSON() string {
	return r.raw
}

type PlanetPizzaUploadImageResponse struct {
	...
	JSON     planetPizzaUploadImageResponseJSON `json:"-"`
}

// planetPizzaUploadImageResponseJSON contains the JSON metadata for the struct [PlanetPizzaUploadImageResponse]
type planetPizzaUploadImageResponseJSON struct {
...
func (r *PlanetPizzaUploadImageResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r planetPizzaUploadImageResponseJSON) RawJSON() string {
	return r.raw
}
