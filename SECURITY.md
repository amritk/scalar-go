...
This is a generated Go SDK for Testing 12, produced by the Scalar SDK Generator (https://scalar.com).
...
If the issue is in the Testing 12 API or service rather than in this SDK, report it through the security process Testing 12 has published.
