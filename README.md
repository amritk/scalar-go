...
This library provides convenient access to the Scalar Go Test REST API from Go.
...
| `option.WithBaseURL` | `func(string) option.RequestOption` | `os.Getenv("SCALAR_GO_TEST_BASE_URL")` | Override the default API base URL. |
